...
def get_PER(model):
    ...
    Y_hat, Y_prob = get_model_predictions(model, timit_test)
    ...
    PER = phone_error_rate(decoded_phone_sequences_folded, true_phone_sequences_folded)
    print "Phone error rate (decoded, folded):", PER
    return PER
