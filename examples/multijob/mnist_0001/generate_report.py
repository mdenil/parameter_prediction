...
if __name__ == "__main__":
    ...
    for i, (model, params) in enumerate(model_params):
        ...
        line = ",".join(map(str, [
            ...
            params['n_columns'],
            params['job_id'],
            model.monitor.channels["train_y_misclass"].val_record[-1],
            model.monitor.channels["test_y_misclass"].val_record[-1],
            ]))
    ...
    df["train_y_acc"] = 1.-df["train_y_misclass"]
    df["test_y_acc"] = 1.-df["test_y_misclass"]
